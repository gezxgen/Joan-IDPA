...
# Define the base directory with absolute path to sound files
BASE_DIR = "/home/joan/Downloads/IDPA-main"
...
def play_sound(sound_file):
    try:
        ...
        subprocess.Popen(['cvlc', '--play-and-exit', '--no-video', full_path], 
